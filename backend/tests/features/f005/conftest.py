...
@pytest.fixture
async def f005_engine(tmp_path: Path) -> AsyncGenerator[AsyncEngine, None]:
    db_file = tmp_path / "aily-f005.db"
...
@pytest.fixture
def f005_session_maker(f005_engine: AsyncEngine) -> async_sessionmaker[AsyncSession]:
